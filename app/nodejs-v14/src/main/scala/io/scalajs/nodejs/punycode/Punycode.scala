...
/** The version of the punycode module bundled in Node.js is being deprecated. In a future major version of Node.js this
  * module will be removed. Users currently depending on the punycode module should switch to using the
...
trait Punycode extends js.Object {
  ...
  /** The punycode.decode() method converts a Punycode string of ASCII-only characters to the equivalent string of
    * Unicode codepoints.
    * @param string
  ...
  /** The punycode.encode() method converts a string of Unicode codepoints to a Punycode string of ASCII-only
    * characters.
    * @param codePoints
...
trait UCS2 extends js.Object {
  ...
  /** The punycode.ucs2.decode() method returns an array containing the numeric codepoint values of each Unicode symbol
    * in the string.
    * @param string
