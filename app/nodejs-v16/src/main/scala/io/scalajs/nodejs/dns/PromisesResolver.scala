...
class PromisesResolver extends js.Object {
  ...
  def resolve4(hostname: String, options: TtlOptions): js.Promise[js.Array[String]] = js.native
  def resolve4(hostname: String): js.Promise[js.Array[String]]                      = js.native
  def resolve6(hostname: String, options: TtlOptions): js.Promise[js.Array[String]] = js.native
